angular.module("umbraco").controller("Skybrud.IconPicker.Controller", function ($scope, $element, editorState) {
    ...
    $scope.add = function () {
        $scope.overlay = {
            view: "/App_Plugins/Skybrud.Umbraco.IconPicker/Views/IconPickerOverlay.html",
            show: true,
            title: "Select icon",
            config: $scope.config,
